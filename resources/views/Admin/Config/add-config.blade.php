            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        @endif
                        <form method="post" action="{{url('admin/config')}}" class="form-horizontal">
                            {{csrf_field()}}

                            <div class="hr-line-dashed"></div>
                            <div class="form-group"><label class="col-sm-2 control-label">標題</label>

                                <div class="col-sm-10"><input name="conf_title" type="text" class="form-control"></div>
                            </div>

                            <div class="hr-line-dashed"></div>
                            <div class="form-group"><label class="col-sm-2 control-label">名稱</label>

                                <div class="col-sm-10"><input name="conf_name" type="text" class="form-control"></div>
                            </div>

                            <div class="hr-line-dashed"></div>
                            <div class="form-group"><label class="col-sm-2 control-label">類型</label>
                                <div class="col-sm-10">
                                    <label class="radio-inline"><input type="radio" value="input" onclick="ShowValue()" name="field_type" checked="checked"> input &nbsp;&nbsp;</label>
                            ...
                            <div id="field_value" class="form-group"><label class="col-sm-2 control-label">類型值</label>
                                ...
                                <div class="col-sm-10">
                                    <input name="field_value" type="text" class="form-control">
                            ...
                            <div class="form-group"><label class="col-sm-2 control-label">短述</label>
                                <div class="col-sm-10"><textarea name="conf_tips" class="form-control" rows="10"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group"><label class="col-sm-2 control-label">順序</label>
                                ...
                                <div class="col-sm-10"><input name="conf_order" value="1" type="text" class="form-control"></div>
                            </div>
