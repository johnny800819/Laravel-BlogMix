        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="explanation">
                    ...
                    <ul class="decimal">
                        <li>Step1：按下【編輯主類別】按鈕,輸入您的【主類別】名稱。</li>
                        <li>Step2：按下【編輯次類別】按鈕,輸入您的【次類別】名稱後,並指定到【對應的主類別】當中。</li>
                        <li>Step3：編輯文章時,選擇此文章歸屬在那一種類別中。</li>
                    </ul>
                </div>
                        ...
                        @endif
                        <form method="post" action="{{url('admin/article/'.$data->art_id)}}" class="form-horizontal">
                            {{method_field('PUT')}}
                            {{csrf_field()}}

                            <div class="form-group"><label class="col-sm-2 control-label">文章標題</label>

                                <div class="col-sm-10"><input name="art_title" type="text" class="form-control" value="{{$data->art_title}}"></div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group"><label class="col-sm-2 control-label">發佈時間</label>

                                <div class="col-sm-10"><input name="art_time" type="date" value="{{$data->art_time}}" class="form-control"></div>
                            </div>
                            <div class="hr-line-dashed"></div>
                                    ...
                                    <select class="form-control m-b" name="cate_id">
                                        @foreach($f_name as $f)
                                            <option value="{{$f->cate_id}}"
                                                @if($f->cate_id == $data->cate_id) selected @endif
                                            >{{$f->cate_name}}</option>
                                        @endforeach
                                    </select>
                                </div>
...
{{--<div class="form-group"><label class="col-sm-2 control-label">顯示是否</label>--}}
                            ...
                            <div class="form-group"><label class="col-sm-2 control-label">簡述</label>
                                <div class="col-sm-10"><textarea name="art_description" class="form-control" rows="10">{{$data->art_description}}</textarea>
                                </div>
                            </div>

                            <div class="hr-line-dashed"></div>
                            <div class="form-group"><label class="col-sm-2 control-label">標籤</label>
                                <div class="col-sm-10"><input name="art_tag" type="text" value="{{$data->art_tag}}" class="form-control"/>
                                </div>
                            </div>
                            ...
                            <div class="form-group"><label class="col-sm-2 control-label">縮略圖</label>
                                ...
                                <img src="/{{$data->art_thumb}}" id="article_thumb_img" class="col-sm-2 control-label" style="width: 160px; height: 100px;"></img>
                                <input type="hidden" id="art_thumb" name="art_thumb" value="{{$data->art_thumb}}">
                            </div>
                            {{--<div class="hr-line-dashed"></div>--}}
                            ...
                            <div class="form-group"><label class="col-sm-2 control-label">文章內容</label>
                                ...
                                <div class="col-sm-10">
                                    <span class="help-block m-b-none">
                                        <textarea name="art_content" id="editor" rows="30">{!! $data->art_content !!}</textarea>
                                    </span>
                                </div>
                                <script>
                                    //這玩意兒還有待研究...
